...
const styles = StyleSheet.create({
  ...
  input: { fontFamily: theme.font.mono.fontFamily, fontSize: 16, color: theme.color.text, minWidth: 60, padding: 0 },
  domain: { flex: 1, fontFamily: theme.font.mono.fontFamily, fontSize: 16, color: theme.color.textMuted },
